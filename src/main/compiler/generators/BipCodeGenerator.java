...
public class BipCodeGenerator implements IIntermediateCodeGenerator {
    ...
    public IntermediateCodeGeneratorResult generate(List<Token> tokens, List<Symbol> symbolTable) {
        ...
        return new IntermediateCodeGeneratorResult(output, new ArrayList<>());
    }
