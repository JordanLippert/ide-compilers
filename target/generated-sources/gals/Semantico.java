...
import compiler.enums.OperationType;
...
public class Semantico implements Constants
{
    ...
    public void executeAction(int action, Token token) throws compiler.models.SemanticError
    {
        switch (action) {
            ...
            case 12: // read variable (access)
            {
                ...
                if (sym == null) {
                    throw new compiler.models.SemanticError("Symbol not found: " + name);
                }
            ...
            case 13: // assign value to variable
            {
                ...
                if (sym == null) {
                    throw new compiler.models.SemanticError("Variable not declared: " + target.value);
                }

                boolean compatible = TypeCompatibility.isCompatible(OperationType.Equals, value.type, sym.type);
                if (!compatible) {
                    throw new compiler.models.SemanticError("Incompatible types: cannot assign " + value.type + " to " + sym.type);
                }
            ...
            case 14: // capture left-hand side of assignment
            {
                ...
                Symbol sym = findSymbol(symbolsTable, name, currentScope);
                if (sym == null) {
                    throw new compiler.models.SemanticError("Variable not declared: " + name);
                }
            ...
            case 17: // additive operator (+, -)
            {
                OperationType op = switch (token.getLexeme()) {
                    ...
                    default -> throw new compiler.models.SemanticError("Unknown additive operator: " + token.getLexeme());
                };
            ...
            case 18: // multiplicative operator (*, /, %)
            {
                OperationType op = switch (token.getLexeme()) {
                    ...
                    default -> throw new compiler.models.SemanticError("Unknown multiplicative operator: " + token.getLexeme());
                };
                operatorStack.push(op);
                break;
            }
            case 19: // relational or equality operator
            {
                OperationType op = switch (token.getLexeme()) {
                    ...
                    default -> throw new compiler.models.SemanticError("Unknown relational operator: " + token.getLexeme());
                };
                operatorStack.push(op);
                break;
            }
            case 20: // logical operator (&&, ||)
            {
                OperationType op = switch (token.getLexeme()) {
                    ...
                    default -> throw new compiler.models.SemanticError("Unknown logical operator: " + token.getLexeme());
                };
                operatorStack.push(op);
                break;
            }
            ...
            case 35: // redução shift
            {
                ...
                if (!isLiteralCompatible) {
                    throw new compiler.models.SemanticError(
                    ...
                    if (left.value != null && right.value != null) {
                        ...
                        switch (op) {
                            ...
                            case Division -> {
                                ...
                                if (r == 0) throw new compiler.models.SemanticError("Divisão por zero");
            ...
            default:
                throw new compiler.models.SemanticError("Semantico: Invalid action " + action);
        }
    }
    ...
    private void insertIntoSymbolsTable(Symbol sym) throws compiler.models.SemanticError {
